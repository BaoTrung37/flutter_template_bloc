...
/// @nodoc
mixin _$AppState {
  Languages get currentLanguage => throw _privateConstructorUsedError;
...
abstract class $AppStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Languages currentLanguage});
}
...
class _$AppStateImpl implements _AppState {
  const _$AppStateImpl({this.currentLanguage = Languages.en});
  ...
  @override
  String toString() {
    return 'AppState(currentLanguage: $currentLanguage)';
  }
...
abstract class _AppState implements AppState {
  const factory _AppState({final Languages currentLanguage}) = _$AppStateImpl;
