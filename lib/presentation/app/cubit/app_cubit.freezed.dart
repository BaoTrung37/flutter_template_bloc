...
abstract class $AppStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AppStatus status, Languages currentLanguage});
}
...
class _$AppStateImpl implements _AppState {
  const _$AppStateImpl(
      {this.status = AppStatus.initial, this.currentLanguage = Languages.en});
  ...
  @override
  String toString() {
    return 'AppState(status: $status, currentLanguage: $currentLanguage)';
  }
...
abstract class _AppState implements AppState {
  const factory _AppState(
      {final AppStatus status,
      final Languages currentLanguage}) = _$AppStateImpl;
